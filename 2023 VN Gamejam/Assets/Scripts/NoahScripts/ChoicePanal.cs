...
public class ChoicePanal : MonoBehaviour
{
    public static ChoicePanal instance { get; private set; }
    ...
    private IEnumerator GenerateChoices(string[] choices)
    {
        ...
        for (int i = 0; i < buttons.Count; i++)
        {
            ...
            foreach (var button in buttons)
            {
                ...
                Debug.Log(lines);
                buttons[i].layout.preferredHeight = BUTTON_HEIGHT_PADDING + (BUTTON_HEIGHT_PER_LINE * lines);
            }
        }
    }
